...
{
    public partial class FormPlantillasDisciplinaUrbanística : Form
    {
        ...
        public FormPlantillasDisciplinaUrbanística(decimal idPlantilla, FormPrincipal formPrincipal)
        {
            InitializeComponent();
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var expedienteUrbanismo = _urbanismoService.GetExpedienteByClave(Convert.ToDecimal(txtClaveExpedienteMyTao.Text));
